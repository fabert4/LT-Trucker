...
export type BundledStatusCreateModel = {
    ...
    state: BundledStatusCreateModel.state;
    type: BundledStatusCreateModel.type;
};

export namespace BundledStatusCreateModel {
